...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] p-0 m-0 overflow-hidden bg-slate-950 text-white flex flex-col justify-between">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto h-full flex flex-col justify-between p-6 sm:p-12 md:p-16">
        ...
        <div className="max-w-3xl space-y-4 mb-6 mt-auto">
          <motion.h1
        ...
        <div className="flex items-end justify-between gap-4 pb-2 border-t border-white/15 pt-4">
          ...
          {/* Webandcrafts Style "Next" Slide Preview Card (Bottom Right) */}
          <div
            onClick={handleNext}
